                  ...
                  <CardBody>
                    <Row className="d-flex align-items-center justify-content-between">
                      <div className="col">
                        ...
                        <h1 className="h2 font-weight-bold mb-0 fs-1">
                          {serviceFee[0]?.fee}%
                        </h1>
                      </div>
                      <div className="w-50">
                        {update && (
                          <div className="col">
                            ...
                            <form
                              onSubmit={(event) =>
                                updateServiceFee(event, serviceFee[0]?.id)
                              }
                            >
                        ...
                        {!update && (
                          <div className="px-4 mr-4 w-100 d-flex justify-content-end">
                            <Button
                              onClick={() => setUpdate(!update)}
                              className="btn-icon btn-2 px-4 mr-20 py-1"
                              size="sm"
                              color="info"
                              type="button"
                            >
